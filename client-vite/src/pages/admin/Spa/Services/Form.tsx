...
interface SpaServiceFormProps {
    visible: boolean;
    onCancel: () => void;
    onSubmit: (isLoading: boolean, data: SpaService | null, error?: unknown) => void;
    editingService: SpaService | null;
}

const SpaServiceForm: React.FC<SpaServiceFormProps> = ({
    visible,
    onCancel,
    onSubmit,
    editingService
    ...
    const handleSubmit = async (values: any) => {
        ...
        try {
            ...
            let result;
            if (editingService) {
                const updateData: UpdateSpaServiceInput = {
                    id: editingService.id,
                    ...data
                };
                result = await spaServiceService.updateSpaService(editingService.id, updateData);
            } else {
                const createData: CreateSpaServiceInput = data;
                result = await spaServiceService.createSpaService(createData);
            }
