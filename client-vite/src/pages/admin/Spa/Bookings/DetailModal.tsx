...
interface SpaBookingDetailModalProps {
    visible: boolean;
    onCancel: () => void;
    booking: SpaBooking | null;
}

const SpaBookingDetailModal: React.FC<SpaBookingDetailModalProps> = ({
    visible,
    onCancel,
    booking
}) => {
        ...
        >
            <div className="space-y-6">
                <p className="text-xl font-semibold mb-4 break-words">
                    Chi tiết đặt lịch spa {booking.id}
                </p>
...
export default SpaBookingDetailModal;
